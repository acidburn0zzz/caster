...
namespace sqlite3x {
	...
	class sqlite3_connection : noncopyable {
	private:
	...
	public:
		...
		void create(const char *db);
		void replace(const char *db);
	...
	class sqlite3_transaction : noncopyable {
	private:
	...
	class sqlite3_command : noncopyable {
	private:
	...
	public:
		...
		sqlite3_command(sqlite3_connection &con, const char *sql, va_list list);
		sqlite3_command(sqlite3_connection &con, const wchar_t *sql, ...);
		sqlite3_command(sqlite3_connection &con, const wchar_t *sql, va_list list);
